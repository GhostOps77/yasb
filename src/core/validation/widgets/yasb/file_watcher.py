    ...
    "listen_paths": {
        ...
        "schema": {
            ...
            "patterns": {
                ...
                # "description": "List of regex patterns to observe"
            },
            "ignore_patterns": {
                "type": "list",
                "schema": {"type": "string"},
                ...
                # "description": "List of regex patterns to ignore (applied to full path)"
            },
            "ignore_directories": {
                "type": "boolean",
                "default": True
                # "default": DEFAULTS["listen_paths"][0]['ignore_directories']
                # "description": "If true, directory events are ignored"
            },
            "read_file_contents": {
                "type": "boolean",
                "default": False
                # "default": DEFAULTS["listen_paths"][0]['read_file_contents']
                # "description": "If true, read file contents for created/modified events"
            },
            "read_max_bytes": {
                "type": "integer",
                "min": 1,
                ...
                # "description": "Maximum bytes to read from file when read_file_contents is true"
            },
        },
        # "description": "List of file or directory paths to observe"
    },
        ...
        "schema": {
            "file": {
                ...
                "schema": {
                    "created": {
                        "type": "string",
                        "default": DEFAULTS['labels']['file']['created']
                    },
                    "modified": {
                        "type": "string",
                        "default": DEFAULTS['labels']['file']['modified']
                    },
                    "deleted": {
                        "type": "string",
                        "default": DEFAULTS['labels']['file']['deleted']
                    },
                    "moved": {
                        "type": "string",
                        "default": DEFAULTS['labels']['file']['moved']
                    }
                },
            },
            "folder": {
                ...
                "schema": {
                    "created": {
                        "type": "string",
                        "default": DEFAULTS['labels']['folder']['created']
                    },
                    "modified": {
                        "type": "string",
                        "default": DEFAULTS['labels']['folder']['modified']
                    },
                    "deleted": {
                        "type": "string",
                        "default": DEFAULTS['labels']['folder']['deleted']
                    },
                    "moved": {
                        "type": "string",
                        "default": DEFAULTS['labels']['folder']['moved']
                    }
                },
            }
        },
