...
VALIDATION_SCHEMA = {
    ...
    "mic_menu": {
        ...
        "schema": {
            ...
            "round_corners": {
                "type": "boolean",
                "default": DEFAULTS["mic_menu"]["round_corners"],
            },
            "round_corners_type": {
                "type": "string",
                "default": DEFAULTS["mic_menu"]["round_corners_type"],
            },
            "border_color": {
                "type": "string",
                "default": DEFAULTS["mic_menu"]["border_color"],
            },
            "alignment": {
                "type": "string",
                "default": DEFAULTS["mic_menu"]["alignment"],
            },
            "direction": {
                "type": "string",
                "default": DEFAULTS["mic_menu"]["direction"],
            },
            "offset_top": {
                "type": "integer",
                "default": DEFAULTS["mic_menu"]["offset_top"],
            },
            "offset_left": {
                "type": "integer",
                "default": DEFAULTS["mic_menu"]["offset_left"],
            },
        },
