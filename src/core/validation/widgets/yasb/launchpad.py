...
VALIDATION_SCHEMA = {
    ...
    "window_animation": {
        ...
        "schema": {
            "fade_in_duration": {
                "type": "integer",
                "default": DEFAULTS["window_animation"]["fade_in_duration"],
            },
            "fade_out_duration": {
                "type": "integer",
                "default": DEFAULTS["window_animation"]["fade_out_duration"],
            },
        },
    ...
    "window_style": {
        ...
        "schema": {
            "enable_blur": {
                "type": "boolean",
                "default": DEFAULTS["window_style"]["enable_blur"],
            },
            "round_corners": {
                "type": "boolean",
                "default": DEFAULTS["window_style"]["round_corners"],
            },
            "round_corners_type": {
                "type": "string",
            ...
            "border_color": {
                "type": "string",
                "default": DEFAULTS["window_style"]["border_color"],
            },
        },
    ...
    "shortcuts": {
        ...
        "schema": {
            ...
            "edit_app": {
                "type": "string",
                "default": DEFAULTS["shortcuts"]["edit_app"],
            },
            "show_context_menu": {
                "type": "string",
                "default": DEFAULTS["shortcuts"]["show_context_menu"],
            },
            "delete_app": {
                "type": "string",
                "default": DEFAULTS["shortcuts"]["delete_app"],
            },
        },
